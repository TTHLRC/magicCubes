  ...
  <div class="create-container">
    <div class="tag mode-toolbar">
      <div @click="handleExport">
        <svg t="1743774915120" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="2698" id="mx_n_1743774915121" data-spm-anchor-id="a313x.search_index.0.i6.48a73a81gHKLlg" width="32"
          height="32">
          <path
      ...
      <div>
        <input type="file" accept=".json" @change="handleImport" style="display: none" ref="fileInput">
        <svg t="1744735971578" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="2645" width="32" height="32" @click="$refs.fileInput.click()">
          <path
            d="M780.8 482.133333l29.866667 29.866667h-298.666667V213.333333l42.666667 42.666667 98.133333 98.133333L789.333333 213.333333l29.866667 29.866667L682.666667 384l98.133333 98.133333z m-72.533333-12.8L554.666667 315.733333V469.333333h153.6zM469.333333 213.333333v42.666667H213.333333v554.666667h554.666667v-256h42.666667v298.666666H170.666667V213.333333h298.666666z"
            fill="#FFD700" p-id="2646"></path>
        </svg>
      </div>

      <div class="mode-tool-btn" title="固定方块" @click="toggleFixMode()">
...
// 显示普通信息
operationStore.setMessage('创造模式：ctrl+左键单击创造方块，右键删除方块', 'success')
...
const toggleFixMode = () => {
  if (threeScene.value?.cubeManager) {
    // 获取所有立方体
    const allCubes = threeScene.value.cubeManager.getAllCubes()
